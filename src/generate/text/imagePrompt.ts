...
async function getMidjourneyPrompt(page: Page, book: Book) {
	const prompt = `Given the a paragraph of a children's book, create a short description of an image to accompany it. Add one specific relevant detail from the page. Make the prompt short and simple. Base the description closely on the examples below:
